...
// section counts as "current". Callers give their own sections
// scroll-mt-32 so an anchor jump lands past the same stack.
const OBSERVER_ROOT_MARGIN = "-140px 0px -60% 0px";

/**
 * Sticky, scroll-spied section navigation shared by every routed page that
 * splits its content into anchored sections (About, Services, ...). One
 * instance per page: give it that page's section ids and labels.
 */
export function PageSubnavList({ items, ariaLabel }: PageSubnavListProps) {
