...
Durum: Kod tarafı uygulandı (Faz 0-5 main'de, PR #2-#6 ve #31, son sürüm v0.3.1); 28 Ağustos denetiminin kod bulguları `feature/audit-closure` dalında, 31 Ağustos incelemesinin ve 2 Eylül 3. turun (`feature/audit-followups`) bulguları sonraki dallarda kapatıldı (bkz. `plans/handoffs/denetim-kapanisi-2026-08-28.md` ve `plans/handoffs/denetim-takip-2026-09-02.md`); kalan: sahibinin panel/DNS adımları, içerik teslimatları, canlı doğrulamalar (site 2026-08-28'de Cloudflare 526 ile kapalı) ve bir typecheck regresyonu (T-56, yerel `audit/acik-kalanlar.md`). Sürüm geçmişi kökteki [`CHANGELOG.md`](../CHANGELOG.md)'de tutuluyor. · Karar: 2026-08-27 · Güncelleme: 2026-09-02 · Kapsam: dogancanyildiz.com
