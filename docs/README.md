...
Durum: Kod tarafı uygulandı (Faz 0-5 main'de, PR #2-#6 ve #31, son sürüm v0.3.1); 28 Ağustos denetiminin kod bulguları `feature/audit-closure` dalında, 31 Ağustos incelemesinin ve 2 Eylül 3. turun (`feature/audit-followups`) bulguları PR #44 ile `dev`'e merge edildi (bkz. `plans/handoffs/denetim-kapanisi-2026-08-28.md` ve `plans/handoffs/denetim-takip-2026-09-02.md`); aynı gün dal `feature/brand-assets` üzerinde yerelleştirilmiş yollar ve çeviri başına slug (`plans/handoffs/yerel-yollar-2026-09-02.md`) ile marka paketi ve içerik turu (`plans/handoffs/marka-ve-icerik-2026-09-02.md`) uygulandı; kalan: sahibinin panel/DNS adımları, içerik teslimatları (kalan beş proje kapağı) ve canlı doğrulamalar (site 2026-08-28'de Cloudflare 526 ile kapalı). Sürüm geçmişi kökteki [`CHANGELOG.md`](../CHANGELOG.md)'de tutuluyor. · Karar: 2026-08-27 · Güncelleme: 2026-09-02 · Kapsam: dogancanyildiz.com
...
| [launch-checklist.md](launch-checklist.md) | Yayın kapısı: otomatik kapılar, içerik, SEO/i18n, performans/erişilebilirlik, contact/altyapı; dogancanyildiz.sh -> dogancanyildiz.com 301 için önce alan adı kararı gerekiyor (.sh -> .com 301, kanonik host www.dogancanyildiz.com, .sh kayıtlı değil) | uygulama, launch öncesi |
...
| [plans/](plans/) | Faz başına uygulama planı (writing-plans formatı), 2026-08-27-faz-0..5 dosyaları; kararlar dokümanlarından türetildi, faz yürütülürken izlendi; `.sh` domain varsayımıyla yazıldığı için `plans/README.md`'deki not; ayrıca faz dışı 2026-09-02-yerel-yollar-ve-ceviri-slug.md | uygulama kaydı |
| [plans/handoffs/](plans/handoffs/) | Faz başına devir notu (faz-N.md), sahibinin manuel checklist'i (faz-N-manual-checklist.md), ek notlar (faz-3-notlar.md, faz-4-brief.md), 28 Ağustos denetim kapanışının devir notu (denetim-kapanisi-2026-08-28.md), 2 Eylül 3. turun devir notu (denetim-takip-2026-09-02.md) ve 2 Eylül faz dışı işlerin devir notları (yerel-yollar-2026-09-02.md, marka-ve-icerik-2026-09-02.md); bir fazın gerçekte ne yaptığının, nelerin sahibi beklediğinin kanıtı | uygulama kaydı |
