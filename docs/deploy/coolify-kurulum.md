...
- [ ] Doğrulama: `TRUST_CF_CONNECTING_IP` yalnızca origin kilidi (Hetzner Cloud Firewall, `docs/deploy/traefik-ve-origin.md` bölüm 5) tamamlandıktan sonra `true` yapılır. Cloudflare'ın arkasında olmayan bir ortama deploy edilirse `false` kalmalı.
