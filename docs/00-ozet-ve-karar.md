...
Durum: Kod tarafı uygulandı (Faz 0-5 main'de, PR #2-#6 ve #31, v0.3.1; 28 Ağustos denetiminin kod bulguları `feature/audit-closure` dalında, 31 Ağustos incelemesinin ve 1-2 Eylül ultrareview'ının bulguları sonraki dallarda kapatıldı; 2 Eylül 3. tur `feature/audit-followups`'ta kapandı; 2026-09-02 `feature/brand-assets`'te kanonik host www kararı kod ve dokümanlara işlendi, apex edge'de www'ye 301 yönlenir), kalan: sahibinin panel/DNS adımları, içerik teslimatları (ilk proje kapağı 2026-09-02'de geldi: Köklü Hukuk case study'si, altıncı proje; Konuşmalar verisi, sertifika linkleri ve diğer beş kapak hâlâ açık), canlı doğrulamalar, `.sh` alan adı kararı ve bir typecheck regresyonu (bkz. aşağıdaki 3. tur notu) · Karar: 2026-08-27 · Güncelleme: 2026-09-02 · Kapsam: dogancanyildiz.com
