...
title: Cargo Pilot
slug: cargo-pilot
summary: A platform that takes over the load planning logistics teams used to run on paper and spreadsheets. As DevOps chapter lead I set up the infrastructure and worked on the core of the placement optimization.
