...
outcome: Over the last three months (June to August 2026) Google search returned 1,020 impressions and 33 clicks at an average position of 11.9. No ads, all organic.
featured: true
order: 1
---
...
Keeping a client site current for two years is what tells you when a rebuild is due. Individually small changes pile up until the architecture resists every new request, and patching costs more than starting over. The second lesson came from search: visibility is slow and it is measurable. An average position of 11.9 is the edge of the second page. With the technical layer in place, the next move is content rather than code.
