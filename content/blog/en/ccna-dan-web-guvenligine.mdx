---
title: "From CCNA to web security: how networking fundamentals shape application decisions"
slug: ccna-dan-web-guvenligine
date: 2026-06-10
summary: How the perspective network training gave me changed the decisions I make when building web applications.
tags:
  - network
  - security
  - ccna
...
Knowing the network side did not turn me into a better security specialist overnight, but it let me see where the application ends and the system begins. As a developer, the biggest difference was being able to see that boundary.
